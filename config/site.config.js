...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'alex@inceptionracing.us',
  ...
  email: 'mailto:me@inceptionracing.us',
  ...
  links: [
    {
      name: 'Inception Racing',
      link: 'https://inceptionracing.us',
    },
  ],
